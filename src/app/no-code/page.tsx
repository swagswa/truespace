...
export default function NoCodeSelection() {
  return (
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col gap-4">
          <AnimatedContainer delay={0.4} direction="up">
            <Link href="/no-code/sprint-september-2025">
              <motion.div
                ...
                >
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-white/70 text-sm text-center">
                      Актуальные уроки текущего спринта по No-Code
                    </p>
                  </div>
                </GlassButton>
              </motion.div>
              ...
              >
                ...
                >
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-white/70 text-sm text-center">
                      Все предыдущие уроки и материалы по No-Code
                    </p>
                  </div>
                </GlassButton>
              </motion.div>
