...
export default function BeginnersSprint() {
  const [lessons, setLessons] = useState([
    ...
    },
    {
      ...
      description: "Как выбрать первый язык программирования. Сравнение Python, JavaScript, Java и других популярных языков для начинающих.",
      liked: true,
      completed: true,
      isExpanded: false,
    },
    {
      ...
      description: "Установка и настройка IDE, редакторов кода. Знакомство с Visual Studio Code, настройка расширений и инструментов разработки.",
      liked: false,
      completed: false,
      isExpanded: false,
    },
    {
      ...
      description: "Создание первой программы на выбранном языке. Понимание структуры кода, компиляция и запуск программы.",
      liked: true,
      completed: false,
      isExpanded: false,
    },
    {
      ...
      description: "Изучение различных типов данных: числа, строки, булевы значения. Объявление переменных и работа с ними.",
      liked: false,
      completed: false,
      isExpanded: false,
    },
    {
      ...
      description: "Основы логики программирования. Условные операторы if/else, циклы for и while. Создание интерактивных программ.",
      liked: false,
      completed: true,
      isExpanded: false,
    },
